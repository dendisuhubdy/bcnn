...
%% bilinear pooling CNN
 ...
 % layers
  ...
  impbcnnvd.opts = {...
    'type', 'impbcnn', ...
    'model', '/data/tsungyulin/Research/bcnn_release/data/test_impbcnnvd/cub-seed-01/fine-tuned-model/final-model.mat', ...
    'layer', 30,...
    'pow', 0.5, ...
    'sigma', 1, ...
    'method', 'schulz', ...
  ...
  setupNameList = {'impbcnnvd'};   % list of models to train and test
    ...
    for jj = 1 : numSplits
      for ee = 1: numel(encoderList)
        ...
        model_train(...
            ...
            'prefix', 'impbcnnvd_svm', ...              % name of the output folder
